/// //////////////////////////////////////////////////////////////////////////////////////////////
/// CLAS 12 RG-A inbending fiducial cuts
///
/// author: Stefan Diehl (sdiehl@jlab.org)
///
/// preliminary version 04/16/2020
///

/// ///////////////////////////////////////////////////////////////////////
/// 0.1 required global variables

float Ebeam = 10.6041;

// aelect one of the following:
bool inbending  = true;
bool outbending = false;
//

/// ///////////////////////////////////////////////////////////////////////
/// 0.2 Assigment of variables from the hipo banks to the used variables
  ...
  for(Int_t i = 0; i < Npart; i++){
    if( i < BUFFER){
      ...
      part_chi2pid[i] = vpart_chi2pid->at(i);
    }
  } 
  ...
  if(TRK_Nentries > 0){
    for(int i = 0; i < TRK_Nentries; i++){
      if(vTRK_pindex->at(i) < BUFFER && vTRK_detector->at(i) == 6){     // DC
        ...
        part_DC_Track_status[vTRK_pindex->at(i)] = vTRK_status->at(i);
      }
    }
  }
...
bool DC_fiducial_cut_chi2(int j, int region){
