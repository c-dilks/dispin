...
void EventTree::GetEvent(Long64_t i) {
  ...
  */
  ...
  // QA cuts
  if(runnum == 16333 || runnum == 16771)
    cutQA = true;
  else if(!useMCrec && !useMCgen && !useStringSpinner)
...
Bool_t EventTree::CheckSampFrac() {
  ...
  if(eleSector>=1 && eleSector<=6) {
    ...
    if( (runnum>=5032 && runnum<=5666) || (runnum>=6616 && runnum<=6783) || (runnum==16333 || runnum==16771)) { // RGA
