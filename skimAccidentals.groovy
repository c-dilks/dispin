// read info for exploring accidentals contribution
// -- this is a hacked version of skimDihadrons.groovy
...
// define root file
"mkdir -p accidentals".execute()
def diskimName = 'accidentals/' + inHipoName.tokenize('/')[-1] + '.root'
