...
vars.each do |var|
  ...
  if row%NumRows==NumRows-1 or row==vars.length-1
    ...
    caption += " The black open circles denote MC data."#+"; for the combined inbending and outbending set, two MC sets are shown separately for RGA and RGB, with corresponding markers and colors."
